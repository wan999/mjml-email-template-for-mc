...
In the two .html files is a very basic design featuring a banner image, inline image with side-column, header, sub-header and body text with "mc:" tags added to allow for the design to be customised within Mailchimp.  
